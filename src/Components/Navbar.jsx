...
const Navbar = () => {
  ...
  return (
    <div className='absolute w-full flex justify-between p-4 items-center'>
        <h1 className='absolute top-0 text-white font-bold text-2xl z-20'>Experiences</h1>
       <HiMenuAlt3  className='absolute top-0 right-0 z-20  text-white cursor-pointersize={25}' onClick={handleNav}/>
        <div 
            className={
                   nav
